...
MEDIA_ENGINE_WORKER_IMAGE=jimstro/media-engine:0.4.0
...
```dotenv
MEDIA_ENGINE_WORKER_IMAGE=jimstro/media-engine:rk1-0.4.0
...
```dotenv
MEDIA_ENGINE_WORKER_IMAGE=jimstro/media-engine:jetson-xavier-nx-0.4.0
